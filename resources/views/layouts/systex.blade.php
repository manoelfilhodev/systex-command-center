    ...
    <style>
        ...
        * {
        ...
        .auth-page {
            ...
            align-items: stretch;
            background:
                linear-gradient(135deg, rgba(255,42,42,0.08), transparent 34%),
        ...
        .auth-brand-mark span {
            ...
            box-shadow: 0 0 20px rgba(255,42,42,0.72);
        }
        ...
        .auth-panel-wrap {
            ...
            align-items: center;
            padding: clamp(32px, 7vh, 76px) clamp(22px, 3vw, 42px) clamp(24px, 4vh, 32px);
        }
